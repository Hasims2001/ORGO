...
public class knowdontnAdapter extends ArrayAdapter<String> {
    ...
    public knowdontnAdapter(Context context, int resource, String[] heading, String[] txt) {
        super(context, resource, heading);
        this.context = context;
        this.dropheading = heading;
        this.droptxt = txt;
