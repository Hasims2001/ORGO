...
public class donor_info extends AppCompatActivity {
    FirebaseDatabase firebaseDatabase;
    DatabaseReference paths, delparent;

    ListView donorlist;
    String[] str_useraadhar,str_username;
    TableLayout donor_details;
    Button updateit;
    EditText input_donorid, input_aadhar, input_name, input_phone, input_mail, input_address,input_age, input_username, input_checkup,inputSearch;
    @Nullable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paths = firebaseDatabase.getReference("donor_info");
        donor_details = findViewById(R.id.donor_details);
        updateit = findViewById(R.id.updateit);
        input_donorid = findViewById(R.id.input_donorid);
                ...
                if (clicked_user != null && !clicked_user.isEmpty()) {
                    ...
                    check_user.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if (snapshot.exists()){
                                donor_details.setVisibility(View.VISIBLE);
                                ...
                                for (DataSnapshot getdata : snapshot.getChildren()) {
                                    input_donorid.setText(getdata.child("donorid").getValue(String.class));
                    ...
                    donor_details.setVisibility(View.INVISIBLE);
                    ...
                    dia = new userdataAdapter(donor_info.this, R.layout.user_data_layout, str_useraadhar, str_username);
                    donorlist.setAdapter(dia);
                }
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                donor_info.this.dia.getFilter().filter(cs);
            }
    ...
    private void infochecking() {
        String id = input_donorid.getText().toString().trim();
