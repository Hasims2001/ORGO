...
public class body_direction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_body_direction);

        drawerLayout = findViewById(R.id.body_dir);
        ...
        nobtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(body_direction.this, "Thank you", Toast.LENGTH_SHORT).show();
